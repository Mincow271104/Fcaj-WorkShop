...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | ----------------------------------------- |
| 2,3   | - Lên kế hoạch để làm chức năng cho đề tài: <br> + Sử dụng công nghệ bình thường để làm trước, sau đó sẽ chuyển qua thành các dịch vụ AWS sau.                                                                                  | 25/05/2026   | 26/05/2026      |
